	...
	public class MockAppService : IAppService
	{
		...
		public async Task Initialize()
		{
			await Task.Run(() =>
			{
				...
				_clientJobsList = new List<Job>();

				var newClient = new Client { Id = "C1", Name = "MYER Groups Pty Ltd.", ContactNumber = "(03)9400 1234", Email = "hello@myer.com.au" };
				newClient.BillingAddress = new ContactAddress { Id = "A1", AddressLine1 = "200 Lonsdale Street", Suburb = "Melbourne", State = "VIC", PostCode = "3000" };
				_clientList.Add(newClient);

				newClient = new Client { Id = "C2", Name = "JB HI-FI Australia Pty Ltd.", ContactNumber = "(03)9412 2800", Email = "hello@jbhifi.com.au" };
				newClient.BillingAddress = new ContactAddress { Id = "A2", AddressLine1 = "130 Warrigal Road", Suburb = "Chadstone", State = "VIC", PostCode = "3158" };
				_clientList.Add(newClient);
		...
		public async Task<Client> AddClient(NewClient addClient)
		{
			return await Task.Run(() =>
			{
				var newClientAddress = new ContactAddress { Id = "A" + _clientList.Count + 1, AddressLine1 = addClient.AddressLine1, AddressLine2 = addClient.AddressLine2, Suburb = addClient.Suburb, State = addClient.State, PostCode = addClient.PostCode, Country = addClient.Country };
